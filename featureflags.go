...
func (poller *FeatureFlagsPoller) loadFlagDefinitionsFromCache() bool {
	...
	poller.applyFlagDefinitions(*data, "", false, 0)
...
// new state.
func (poller *FeatureFlagsPoller) applyFlagDefinitions(data FlagDefinitionCacheData, etag string, minimalFlagCalledEvents bool, propertyMatchingVersion int) {
...
func (poller *FeatureFlagsPoller) fetchFlagDefinitions(publish bool) {
	...
	poller.applyFlagDefinitions(data, res.Header.Get("ETag"), featureFlagsResponse.MinimalFlagCalledEvents, featureFlagsResponse.PropertyMatchingVersion)
